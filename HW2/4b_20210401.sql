WITH cases_210401(Date,Continent_Name,Country_Code,ConfirmedCases) AS(
	SELECT 
	cases.Date,
	...
	WHERE Date='20210325' OR Date='20210401'
),
average_7day_210401(Continent_Name,Country_Code,Case_average) AS(
	...
	END
	FROM cases_210401 AS t1, cases_210401 AS t2
	WHERE t1.Country_Code=t2.Country_Code
	AND t2.Date='20210401' AND t1.Date='20210325'
),
overindex_210401(Date,Continent_Name,Country_Name,Over_Stringency_Index) AS(
	SELECT '20210401' AS Date, a1.Continent_Name, indices.Country_Name,
